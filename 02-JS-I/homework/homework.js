...
console.log(tienenMismaLongitud("jossue", "lesly"));
...
console.log(redondearNumero(83.5));
...
console.log(redondearHaciaArriba(60.1));
...
console.log(combinarNombres("jossue", "Arbieto"));
...
console.log(obtenerSaludo("Jossue"));
...
console.log(areaDelTriangulo(10, 30));
